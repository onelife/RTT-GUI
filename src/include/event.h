...
#define RTGUI_EVENT(e)  ((rtgui_evt_t *)(e))
...
#define rtgui_event_show rtgui_evt
#define rtgui_event_hide rtgui_evt
...
typedef union rtgui_evt_generic {
    struct rtgui_evt base;
